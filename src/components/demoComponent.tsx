    ...
    <>
      ...
      <div className="space-x-1 py-2 px-2">
        ...
        <div className="overflow-hidden rounded-md">
          <Image
            src="https://outfit-visualizer.s3.us-west-1.amazonaws.com/randomGirl.png-whiteBackground-1704839743510"
            alt={"broken"}
            width={512}
            height={512}
            className="h-auto w-auto transition-all hover:scale-105"
          />
        </div>
      </div>
    </>
